...
{
    /// <summary>
    /// SupervisorConfigCreateJobViewModel view model concrete class derived from <see cref="XPubViewModelBase"/>
    ...
    public class SupervisorConfigCreateJobViewModel : XPubViewModelBase
    {
        #region Fields
        /// <summary>
        ...
        /// <summary>
        /// Message Property Get / Set Message
        /// </summary>
        /// <value>string</value>
        ...
        /// <summary>
        /// CreateJobPopViewModel Property Get / Set Message
        /// View model for the create job pop up window
        /// </summary>
        ...
        // public AdminConfigCreateJobViewModel()

        public SupervisorConfigCreateJobViewModel(IXPubServiceAdmin xpubServiceAdmin
            , IEventAggregator eventAggregator)
        {
            _eventAggregator = eventAggregator;
            Message = "Supervisor Create Job View";
        ...
        /// Asynchronous method used to obtain a collection of record file information
        /// </summary>
        /// <returns></returns>
        async Task<ObservableCollection<IXPubConfigRecordDataModel>> GetFileRecordInformationAsynv()
        {
            //+ResultContent   Count = 24  dynamic { System.Collections.Generic.List<XPub.Interfaces.Models.IXPubRecordModel>}
